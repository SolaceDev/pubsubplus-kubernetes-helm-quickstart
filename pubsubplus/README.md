# Solace Event Broker Software - Helm Chart
...
Refer to the detailed Solace Kubernetes documentation for:
...
| `solace.podDisruptionBudgetForHA`  | `true` will set up a [Pod disruption budget](https://kubernetes.io/docs/tasks/run-application/configure-pdb/) for the Solace Event Broker in HA deployment, `false` does not set up a pod disruption budget. HA deployment with Primary, Backup and Monitor nodes requires a minimum of 2 nodes to reach a quorum, the pod disruption budget is defaulted to `2` minimum nodes when enabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `false`                                                                         |
...
| `image.pullSecretName`         | Name of the ImagePullSecret to be used with the Solace Event Broker container image registry                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Undefined, meaning no ImagePullSecret used                                      |
...
| `securityContext.runAsUser`    | Specifies `runAsUser` in pod security context                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | set to default Solace Event Broker appuser id 1000001                           |
...
| `service.ports`                | Define service ports exposed for the Solace Event Broker Software. servicePorts are external, mapping to cluster-local pod containerPorts                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | initial set of frequently used ports, refer to values.yaml                      |
...
| `storage.useStorageGroup`      | `true` to use a single mount point storage-group, as recommended from Solace Event Broker version 9.12. Undefined or `false` is legacy behavior. Note: legacy mount still works for newer versions but may be deprecated in the future.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Undefined                                                                       |
